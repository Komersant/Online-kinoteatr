...
type NoveltiesItemInfoProps = {
	noveltiesItem: moviesType
}

const NoveltiesItemInfo: FC<NoveltiesItemInfoProps> = ({ noveltiesItem }) => {
	return (
		<>
			{noveltiesItem.map((el) => (
...
export default NoveltiesItemInfo